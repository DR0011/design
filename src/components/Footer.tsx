...
const Footer: React.FC = () => {
  return (
    <footer className="relative w-full h-auto bg-[#0A1330] text-white flex flex-col items-center justify-center px-4 sm:px-8 py-8 sm:py-12">
      <div className="w-full max-w-[1440px]">
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between">
          <div className="flex flex-col items-center sm:items-start">
            <UrbantapLogoWhite />
            <div className="flex flex-col justify-center items-center sm:items-start p-0 gap-2 mt-4">
              <h1 className="text-sm font-semibold leading-[125%] text-[#D5F6FB] opacity-30">
                © urbantap LLC. 2024
              </h1>
              <p className="text-xs sm:text-sm leading-[125%] text-white opacity-30 text-center sm:text-left">
                © 2024 UrbanTap LLC. All trademarks, names, and logos are
                property of UrbanTap LLC and are registered or used in the UAE.
